...
import { DEFAULT_SERVER_SETTINGS, type ProviderKind, type ServerProviderStatus, type ServerSettings } from "@t3tools/contracts";
...
function serverSettings(overrides: Partial<ServerSettings["providers"]> = {}): ServerSettings {
  ...
  return {
    ...
    skills: { disabled: [] },
    remoteAccess: DEFAULT_SERVER_SETTINGS.remoteAccess,
  };
}
